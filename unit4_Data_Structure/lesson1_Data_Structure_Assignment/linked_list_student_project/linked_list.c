...
void Get_Nth(){
	...
	DPRINTF("\n Enter number to get Nth Node: ");
	gets(temp_text);
	n_th = atoi(temp_text);

	 while ((count < n_th) && (pCurrentStudent != NULL))
	 {
		pCurrentStudent = pCurrentStudent->pNextStudent;
		count++;
	 }
