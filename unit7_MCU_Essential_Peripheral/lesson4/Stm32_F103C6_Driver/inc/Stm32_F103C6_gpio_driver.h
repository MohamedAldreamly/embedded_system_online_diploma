...
//Config Stucture
typedef struct{
	uint16_t GPIO_PinNumber;	// Specifies the GPIO pins configured
							//This parameter can be a value of @ref GPIO_PINS_define

	uint8_t GPIO_MODE; 	//Specifies the operating mode for the selescted pins
						//this parameter can be a value of @GPIO_MODE_define

	uint8_t GPIO_Output_Speed; //	Specifies the speed for the selescted pins
...
#define GPIO_PIN_MASK	0x0000FFFFu /*PIN mask for assret test*/
